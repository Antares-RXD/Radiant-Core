...
cd "/Users/main/Downloads/Radiant-Core-main/macos-release-arm64/doc"
rm -f mkdocs.yml
rm -rf md
mkdir md
...
find . \( \
  ...
  -print0 \
  | tar cf - --null -T - \
  | tar xf - --directory "/Users/main/Downloads/Radiant-Core-main/macos-release-arm64/doc/md"
cd "/Users/main/Downloads/Radiant-Core-main/macos-release-arm64/doc"
...
../src/radiantd -daemon -debuglogfile=0 -regtest -datadir="/Users/main/Downloads/Radiant-Core-main/macos-release-arm64/doc/md/doc/json-rpc/tmp" -rpcuser=gen-manpages -rpcpassword=gen-manpages
...
while IFS= read -r line; do
  ...
  if [ "${line: -23}" == " doc/json-rpc/README.md" ]; then
    ...
    ../src/radiant-cli -rpcwait -regtest -datadir="/Users/main/Downloads/Radiant-Core-main/macos-release-arm64/doc/md/doc/json-rpc/tmp" -rpcuser=gen-manpages -rpcpassword=gen-manpages help | while read -r helpline; do
      if [ -n "$helpline" ]; then
        if [[ "$helpline" =~ ^==[[:space:]](.*)[[:space:]]==$ ]]; then
          ...
          "/Users/main/Downloads/Radiant-Core-main/contrib/devtools/rpc-help-to-markdown.py" "$(../src/radiant-cli -rpcwait -regtest -datadir="/Users/main/Downloads/Radiant-Core-main/macos-release-arm64/doc/md/doc/json-rpc/tmp" -rpcuser=gen-manpages -rpcpassword=gen-manpages help $command)" > "md/doc/json-rpc/$command.md"
          {
              echo
              echo "***"
              echo
...
../src/radiant-cli -rpcwait -regtest -datadir="/Users/main/Downloads/Radiant-Core-main/macos-release-arm64/doc/md/doc/json-rpc/tmp" -rpcuser=gen-manpages -rpcpassword=gen-manpages stop
