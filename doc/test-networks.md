...
- testnet (current public testnet)
- scalenet
...
(daemon, GUI and CLI) with `-testnet` and `-scalenet`
...
Testnet is the current public testnet in Radiant (replacing the historical testnet3).
It is intended to be kept light-weight and quick to sync.

Testnet has a reduced default blocksize to discourage high throughput and
...
| Attribute/Network            |  testnet    |  scalenet   |
|------------------------------|-------------|-------------|
| Default p2p port             |  27333      |  38333      |
| Network magic bytes          |  0xe2b7daaf |  0xc3afe1a2 |
| CashAddr prefix              |  bchtest    |  bchtest    |
| Default excessive block size |  2MB        |  256MB      |
| Block Target spacing         |  10 min     |  10 min      |
| POW limit                    |  2^224      |  2^224      |
| ASERT half-life              |  1 hour     |  2 days     |
| Allow min diff blocks        |  yes        |  yes        |
| Require standard txs         |  yes        |  no         |
| Default consist. chks.       |  no         |  no         |
| Halving interval (blks)      |  210000     |  210000     |
| BIP16 height                 |  1          |  1          |
| BIP34 height                 |  2          |  2          |
| BIP65 height                 |  3          |  3          |
| BIP66 height                 |  4          |  4          |
| CSV height                   |  5          |  5          |
| UAHF (BCH fork) height       |  6          |  6          |
| Nov 13 2017 HF height        |  3000       |  3000       |
| Nov 15 2018 HF height        |  4000       |  4000       |
| Nov 15 2019 HF height        |  5000       |  5000       |
| May 15 2020 HF height        |  0 (Note 1) |  0 (Note 1) |
| Nov 15 2020 HF height        |  16845      |  variable (Note 2) |
| Base58 prefix: pubkey        |  1, 111     |  1, 111     |
| Base58 prefix: script        |  1, 196     |  1, 196     |
| Base58 prefix: seckey        |  1, 239     |  1, 239     |
| Base58 p: ext. pubkey        |  0x043587cf |  0x043587cf |
| Base58 p: ext. seckey        |  0x04358394 |  0x04358394 |
