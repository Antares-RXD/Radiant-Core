...
class InvalidBlockRequestTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Clear the block store to avoid sending previously corrupted blocks
        # when the node requests blocks after receiving block3's header
        node.p2p.block_store = {}

        block3 = create_block(tip, create_coinbase(height), block_time)
        block_time += 1
        block3.vtx[0].vout[0].nValue = 100000 * COIN  # Too high! (subsidy is 50000 * COIN)
