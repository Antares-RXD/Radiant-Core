...
# Radiant hash opcodes
OP_SHA512_256 = CScriptOp(0xce)
OP_HASH512_256 = CScriptOp(0xcf)

# Radiant reference opcodes
OP_PUSHINPUTREF = CScriptOp(0xd0)
OP_REQUIREINPUTREF = CScriptOp(0xd1)
OP_DISALLOWPUSHINPUTREF = CScriptOp(0xd2)
OP_DISALLOWPUSHINPUTREFSIBLING = CScriptOp(0xd3)
OP_REFHASHDATASUMMARY_UTXO = CScriptOp(0xd4)
OP_REFHASHVALUESUM_UTXOS = CScriptOp(0xd5)
OP_REFHASHDATASUMMARY_OUTPUT = CScriptOp(0xd6)
OP_REFHASHVALUESUM_OUTPUTS = CScriptOp(0xd7)
OP_PUSHINPUTREFSINGLETON = CScriptOp(0xd8)
OP_REFTYPE_UTXO = CScriptOp(0xd9)
OP_REFTYPE_OUTPUT = CScriptOp(0xda)
OP_REFVALUESUM_UTXOS = CScriptOp(0xdb)
OP_REFVALUESUM_OUTPUTS = CScriptOp(0xdc)
OP_REFOUTPUTCOUNT_UTXOS = CScriptOp(0xdd)
OP_REFOUTPUTCOUNT_OUTPUTS = CScriptOp(0xde)
OP_REFOUTPUTCOUNTZEROVALUED_UTXOS = CScriptOp(0xdf)
OP_REFOUTPUTCOUNTZEROVALUED_OUTPUTS = CScriptOp(0xe0)
OP_REFDATASUMMARY_UTXO = CScriptOp(0xe1)
OP_REFDATASUMMARY_OUTPUT = CScriptOp(0xe2)
OP_CODESCRIPTHASHVALUESUM_UTXOS = CScriptOp(0xe3)
OP_CODESCRIPTHASHVALUESUM_OUTPUTS = CScriptOp(0xe4)
OP_CODESCRIPTHASHOUTPUTCOUNT_UTXOS = CScriptOp(0xe5)
OP_CODESCRIPTHASHOUTPUTCOUNT_OUTPUTS = CScriptOp(0xe6)
OP_CODESCRIPTHASHZEROVALUEDOUTPUTCOUNT_UTXOS = CScriptOp(0xe7)
OP_CODESCRIPTHASHZEROVALUEDOUTPUTCOUNT_OUTPUTS = CScriptOp(0xe8)
OP_CODESCRIPTBYTECODE_UTXO = CScriptOp(0xe9)
OP_CODESCRIPTBYTECODE_OUTPUT = CScriptOp(0xea)
OP_STATESCRIPTBYTECODE_UTXO = CScriptOp(0xeb)
OP_STATESCRIPTBYTECODE_OUTPUT = CScriptOp(0xec)
OP_PUSH_TX_STATE = CScriptOp(0xed)

# Glyph v2 dMint hash opcodes (Hard Fork V2)
OP_BLAKE3 = CScriptOp(0xee)
OP_K12 = CScriptOp(0xef)
