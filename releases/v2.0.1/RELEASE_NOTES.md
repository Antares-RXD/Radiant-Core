# **Radiant Core 2.0.1 Release Notes**

> **Note**: This is a patch release that corrects the ASERT activation height to block 410,000. If you downloaded v2.0.0, please upgrade to v2.0.1.
...
Radiant Core 2.0.1 is a **mandatory upgrade** that includes consensus changes activating at block height **410,000**. All node operators, miners, exchanges, and wallet providers **must upgrade before block 410,000** to remain on the main chain.
...
| Platform | File | Size |
|----------|------|------|
| Docker (x86_64) | radiant-core-docker-v2.0.1.tar.gz | ~35 MB |
| Linux x86_64 | radiant-core-linux-x64-v2.0.1.tar.gz | ~4.0 MB |
| macOS ARM64 | radiant-core-macos-arm64-v2.0.1.tar.gz | ~2.9 MB |
| macOS GUI App | Radiant-Core-GUI-2.0.1.dmg | ~19 MB |
| Windows x64 | radiant-core-windows-x64-v2.0.1.zip | ~12.5 MB |
...
**Download:** [Radiant-Core-GUI-2.0.1.dmg](https://github.com/RadiantBlockchain/Radiant-Core/releases/download/v2.0.1/Radiant-Core-GUI-2.0.1.dmg)
### Features
...
Download Radiant-Core-GUI-2.0.1.dmg, open it, drag to Applications, and launch.
...
**Download:** [RadiantCore.exe](https://github.com/RadiantBlockchain/Radiant-Core/releases/download/v2.0.1/RadiantCore.exe)
### Features
- **One-click node operation** - Start/stop your node without command line
- **Built-in wallet** - Send and receive RXD with full self-custody
- **Seed phrase backup** - BIP39 mnemonic for wallet recovery
...
wget https://github.com/RadiantBlockchain/Radiant-Core/releases/download/v2.0.1/radiant-core-linux-x64-v2.0.1.tar.gz
tar xzf radiant-core-linux-x64-v2.0.1.tar.gz
...
1. Upgrade to Radiant Core 2.0.1 **before block 410,000**
2. No configuration changes required
3. The fee policy will automatically adjust at activation

### For Exchanges

1. Upgrade to Radiant Core 2.0.1
